...
.. note::
    ...
    Currently only SLURM scripts are supported. Feel free to `open an issue <https://github.com/KosinskiLab/pyTME/issues>`_ if you require a different architecture, or create one yourself by inheriting from the ExecutionBackend defined in ``pytme_runner.py``.
